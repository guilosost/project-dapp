...
public class PinterestNewPostController extends HttpServlet {

	private static final Logger log = Logger.getLogger(PinterestNewPostController.class.getName());

	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
		String accessToken = (String) req.getSession().getAttribute("Pinterest-token");
