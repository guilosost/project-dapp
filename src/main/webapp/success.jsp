...
function emptyBox(id) {
	...
	if(document.getElementById(videoId + "-c").value == "�Comentario publicado con �xito!") {
...
function postCommentYoutube(url1, videoId, channelId) {
	...
	document.getElementById(videoId + "-c").value = "�Comentario publicado con �xito!";
...
function postComentarioDA(url1, token1, id1) {
    ...
    document.getElementById(devid + "-c").value = "�Comentario publicado con �xito!";
    console.log(Data);
    const othePram= {
        method: 'POST',
        //mode: "no-cors",
...
function changeSize(id) {
	console.log("Cambiando tama�o de " + id);
